...
move_uploaded_file($_FILES["img1"]["tmp_name"],"../owner/assets/imagess/".$_FILES["img1"]["name"]);
$sql="update changepayment set qr=:vimage1 where id='1'";
...
<head>
    ...
    <title>FAR | Admin Update Image 1</title>
...
{	?>
                                                ...
                                                <div class="col-sm-8">
                                                    <img src="../owner/assets/imagess/<?php echo htmlentities($result->qr);?>"
