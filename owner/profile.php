...
if (strlen($_SESSION['ologin']) == 0) {
    ...
    if (isset($_POST['updateprofile'])) {
        ...
        $sql = "update tblowner set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
