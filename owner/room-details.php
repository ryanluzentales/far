...
<body>
    ...
    ?>
            ...
            <section id="listing_img_slider">
                <div><img src="../admin/img/vehicleimages/<?php echo htmlen
                tities($result->Vimage1); ?>" class="img-responsive" alt="image" width="900" height="560"></div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="reviews">
                                            <div role="tabpanel" class="reviewtab">
                                                <form action="post_comment.php" class="review-form" method="post">
                                                    <h6 class="create-review">Create review</h6>
                                                    <p class="create-name">
                                                        Your Name:
                                                    </p>
                                                    <input class="name-input" type="" name="name" placeholder="Enter your name here"></td><br>

                                                    <p class="create-comment">Comment:
                                                    </p>
                                                    <textarea class="comment-input" name="comment" rows="5" cols="30" placeholder="Enter your comment here"></textarea> <br>
                                                    <input class="review-bottom" ctype=" submit" name="submit" value="Post">
                                                    </td>
                                                </form>
                                            </div>
                                        </div>
