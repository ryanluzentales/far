    ...
    &q=<?php echo $result->Address; ?>">">
            ...
            <div class="similar_cars">
                ...
                <div class="row">
                    <?php
                            $bid = $_SESSION['brndid'];
                            $sql = "SELECT tblrooms.RoomName,tblrooms.Landmark,tblapartments.Apartmentname,tblrooms.PricePerDay,tblrooms.BathType,tblrooms.Housingtype,tblrooms.id,tblrooms.SeatingCapacity,tblrooms.Overview,tblrooms.Vimage1 from tblrooms join tblapartments on tblapartments.id=tblrooms.Apartmentname where tblrooms.Apartmentname=:bid";
                            $query = $dbh->prepare($sql);
                        ...
                        <div class="product-listing-m gray-bg">
                            ...
                            <div class="product-listing-content">
                                ...
                                <ul class="features_list">
                                    ...
                                    <li><i class="fa "
                                            aria-hidden="true"></i><?php echo htmlentities($result->BathType); ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
