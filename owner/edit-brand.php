...
if (strlen($_SESSION['ologin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		$brand = $_POST['brand'];
		$id = $_GET['id'];
		$sql = "update  tblapartments set Apartmentname=:brand where id=:id";
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form method="post" name="chngpwd" class="form-horizontal"
                                            ...
                                            <?php
												$id = $_GET['id'];
												$ret = "select * from tblapartments where id=:id";
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Apartment anme Name</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control"
                                                        value="<?php echo htmlentities($result->Apartmentname); ?>"
